...
POLICY_EVENTS = [
    ...
    ("2008-01-01", "regulation", "Russia citrus export protocol renewed", "up", 1),
    ("2009-07-01", "regulation", "EU customs union extended to more agricultural goods", "down", 1),
    ("2014-08-01", "sanction", "Russia EU/US food embargo — demand for Turkish citrus rose", "up", 3),
    ("2015-11-24", "sanction", "Russia–Turkey crisis — citrus exports halted", "down", 3),
    ("2016-06-29", "sanction", "Russia–Turkey relations begin to normalize", "up", 2),
    ("2017-01-01", "regulation", "Russia citrus exports fully reopened", "up", 2),
    ("2020-03-15", "pandemic", "COVID-19 — logistics disruption, hal closures", "up", 2),
    ("2020-06-01", "pandemic", "Post-COVID demand surge — healthy-eating trend", "up", 1),
    ("2022-02-24", "sanction", "Russia–Ukraine war — pivot to Turkish citrus", "up", 2),
    ("2022-06-01", "regulation", "Russia port restrictions — alternative-route cost", "up", 1),
    ...
    ("2012-02-01", "frost", "Mediterranean cold wave", "up", 2),
    ("2016-01-10", "frost", "Finike region frost damage", "up", 2),
    ...
    ("2019-07-01", "economic", "Central Bank rate cut — TRY weakness continued", "up", 1),
    ("2021-12-01", "economic", "Sharp TRY depreciation — input + transport cost spike", "up", 3),
    ("2022-06-01", "economic", "Diesel and fertilizer prices up 100%+", "up", 3),
    ("2023-06-01", "economic", "Central Bank returns to orthodox policy — TRY stabilizes", "down", 1),
    ...
    ("2021-07-01", "supply", "Antalya forest fires — some orchards affected", "up", 1),
